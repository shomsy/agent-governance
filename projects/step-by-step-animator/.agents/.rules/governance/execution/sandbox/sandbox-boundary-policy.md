...
## 3. Network, Secret, & Resource Restrictions

- **Secrets Isolation**: Secrets MUST NOT be injected into the AI context window. Use short-lived, scoped tokens in the sandbox only.
