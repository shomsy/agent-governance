---
title: system-shared-logging-how-this-works
owner: platform@polymoly
last_reviewed: 2026-03-13
classification: internal
---

# System Shared Logging How This Works

## What this folder is

`system/shared/logging/` is the home for shared logging shape and logging helpers.

It keeps diagnostic output consistent across the system.
...
sequenceDiagram
    ...
    Entry->>Owned: Step 1: reach `system/shared/logging/` through the current story
...
- when the `system/shared/logging/` story needs this responsibility, it opens `.gitkeep`
...
- `system/shared/logging/` exists so this slice has one obvious home.
