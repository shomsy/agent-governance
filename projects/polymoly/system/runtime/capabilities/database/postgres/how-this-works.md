---
title: system-runtime-capabilities-database-postgres-how-this-works
owner: platform@polymoly
last_reviewed: 2026-03-13
classification: internal
---

# System Runtime Capabilities Database Postgres How This Works

## What this folder is

`system/runtime/capabilities/database/postgres/` is one shipped runtime capability slice.
...
sequenceDiagram
    ...
    participant Next as config/
    participant Result as VisibleResult

    Entry->>Owned: Step 1: reach `system/runtime/capabilities/database/postgres/` through the current story
...
- when the `system/runtime/capabilities/database/postgres/` story needs this responsibility, it opens `base.yaml`
...
- when the `system/runtime/capabilities/database/postgres/` story needs this responsibility, it opens `module.yaml`
...
Open [`init/how-this-works.md`](./init/how-this-works.md).
...
Open [`pooling/how-this-works.md`](./pooling/how-this-works.md).
...
- `system/runtime/capabilities/database/postgres/` exists so this slice has one obvious home.
