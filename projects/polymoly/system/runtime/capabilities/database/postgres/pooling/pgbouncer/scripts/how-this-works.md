---
title: system-runtime-capabilities-database-postgres-pooling-pgbouncer-scripts-how-this-works
owner: platform@polymoly
last_reviewed: 2026-03-13
classification: internal
---

# System Runtime Capabilities Database Postgres Pooling Pgbouncer Scripts How This Works

## What this folder is

`system/runtime/capabilities/database/postgres/pooling/pgbouncer/scripts/` holds shipped helper scripts for this capability.

These scripts are supporting runtime assets. The engine decides when they matter; this folder only ships them.
...
sequenceDiagram
    ...
    Entry->>Owned: Step 1: reach `system/runtime/capabilities/database/postgres/pooling/pgbouncer/scripts/` through the current story
...
- when the `system/runtime/capabilities/database/postgres/pooling/pgbouncer/scripts/` story needs this responsibility, it opens `Dockerfile`
...
- `system/runtime/capabilities/database/postgres/pooling/pgbouncer/scripts/` exists so this slice has one obvious home.
