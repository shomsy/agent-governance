---
title: system-runtime-capabilities-database-postgres-engine-how-this-works
owner: platform@polymoly
last_reviewed: 2026-03-13
classification: internal
---

# System Runtime Capabilities Database Postgres Engine How This Works

## What this folder is

`system/runtime/capabilities/database/postgres/engine/` holds the shipped engine or image build assets for this runtime capability.
...
sequenceDiagram
    ...
    Entry->>Owned: Step 1: reach `system/runtime/capabilities/database/postgres/engine/` through the current story
...
- when the `system/runtime/capabilities/database/postgres/engine/` story needs this responsibility, it opens `Dockerfile`
...
- `system/runtime/capabilities/database/postgres/engine/` exists so this slice has one obvious home.
