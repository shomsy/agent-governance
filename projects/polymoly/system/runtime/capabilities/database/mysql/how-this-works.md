---
title: system-runtime-capabilities-database-mysql-how-this-works
owner: platform@polymoly
last_reviewed: 2026-03-13
classification: internal
---

# System Runtime Capabilities Database Mysql How This Works

## What this folder is

`system/runtime/capabilities/database/mysql/` is one shipped runtime capability slice.
...
sequenceDiagram
    ...
    Entry->>Owned: Step 1: reach `system/runtime/capabilities/database/mysql/` through the current story
...
- when the `system/runtime/capabilities/database/mysql/` story needs this responsibility, it opens `base.yaml`
...
- when the `system/runtime/capabilities/database/mysql/` story needs this responsibility, it opens `module.yaml`
...
- `system/runtime/capabilities/database/mysql/` exists so this slice has one obvious home.
