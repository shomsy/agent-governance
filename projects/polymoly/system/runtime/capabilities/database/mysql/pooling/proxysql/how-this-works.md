---
title: system-runtime-capabilities-database-mysql-pooling-proxysql-how-this-works
owner: platform@polymoly
last_reviewed: 2026-03-13
classification: internal
---

# System Runtime Capabilities Database Mysql Pooling Proxysql How This Works

## What this folder is

`system/runtime/capabilities/database/mysql/pooling/proxysql/` is one shipped runtime capability slice.
...
sequenceDiagram
    ...
    Entry->>Owned: Step 1: reach `system/runtime/capabilities/database/mysql/pooling/proxysql/` through the current story
...
- when the `system/runtime/capabilities/database/mysql/pooling/proxysql/` story needs this responsibility, it opens `go.mod`
...
- `system/runtime/capabilities/database/mysql/pooling/proxysql/` exists so this slice has one obvious home.
