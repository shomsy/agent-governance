---
title: system-runtime-capabilities-database-mysql-pooling-proxysql-cmd-proxysql-runtime-how-this-works
owner: platform@polymoly
last_reviewed: 2026-03-13
classification: internal
---

# System Runtime Capabilities Database Mysql Pooling Proxysql Cmd Proxysql Runtime How This Works

## What this folder is

`system/runtime/capabilities/database/mysql/pooling/proxysql/cmd/proxysql-runtime/` is one shipped runtime capability slice.
...
sequenceDiagram
    ...
    Entry->>Owned: Step 1: reach `system/runtime/capabilities/database/mysql/pooling/proxysql/cmd/proxysql-runtime/` through the current story
...
- when the `system/runtime/capabilities/database/mysql/pooling/proxysql/cmd/proxysql-runtime/` story needs this responsibility, it opens `main.go`
...
- `system/runtime/capabilities/database/mysql/pooling/proxysql/cmd/proxysql-runtime/` exists so this slice has one obvious home.
