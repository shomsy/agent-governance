---
title: system-runtime-capabilities-database-mysql-init-how-this-works
owner: platform@polymoly
last_reviewed: 2026-03-13
classification: internal
---

# System Runtime Capabilities Database Mysql Init How This Works

## What this folder is

`system/runtime/capabilities/database/mysql/init/` holds shipped initialization assets for this capability.
...
sequenceDiagram
    ...
    Entry->>Owned: Step 1: reach `system/runtime/capabilities/database/mysql/init/` through the current story
...
- when the `system/runtime/capabilities/database/mysql/init/` story needs this responsibility, it opens `init.sql`
...
- `system/runtime/capabilities/database/mysql/init/` exists so this slice has one obvious home.
