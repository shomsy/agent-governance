---
title: system-runtime-capabilities-database-mongodb-how-this-works
owner: platform@polymoly
last_reviewed: 2026-03-13
classification: internal
---

# System Runtime Capabilities Database Mongodb How This Works

## What this folder is

`system/runtime/capabilities/database/mongodb/` is one shipped runtime capability slice.
...
sequenceDiagram
    ...
    Entry->>Owned: Step 1: reach `system/runtime/capabilities/database/mongodb/` through the current story
...
- when the `system/runtime/capabilities/database/mongodb/` story needs this responsibility, it opens `base.yaml`
...
- when the `system/runtime/capabilities/database/mongodb/` story needs this responsibility, it opens `module.yaml`
...
- `system/runtime/capabilities/database/mongodb/` exists so this slice has one obvious home.
