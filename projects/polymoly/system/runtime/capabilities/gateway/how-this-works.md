---
title: system-runtime-capabilities-gateway-how-this-works
owner: platform@polymoly
last_reviewed: 2026-03-13
classification: internal
---

# System Runtime Capabilities Gateway How This Works

## What this folder is

`system/runtime/capabilities/gateway/` is one shipped runtime capability slice.
...
sequenceDiagram
    ...
    Entry->>Owned: Step 1: reach `system/runtime/capabilities/gateway/` through the current story
...
- `system/runtime/capabilities/gateway/` exists so this slice has one obvious home.
