---
title: system-runtime-capabilities-storage-contract-how-this-works
owner: platform@polymoly
last_reviewed: 2026-03-13
classification: internal
---

# System Runtime Capabilities Storage Contract How This Works

## What this folder is

`system/runtime/capabilities/storage/contract/` holds the contract files that describe this capability to the rest of the system.
...
sequenceDiagram
    ...
    Entry->>Owned: Step 1: reach `system/runtime/capabilities/storage/contract/` through the current story
...
- when the `system/runtime/capabilities/storage/contract/` story needs this responsibility, it opens `capability.yaml`
...
- `system/runtime/capabilities/storage/contract/` exists so this slice has one obvious home.
