---
title: system-runtime-capabilities-identity-how-this-works
owner: platform@polymoly
last_reviewed: 2026-03-13
classification: internal
---

# System Runtime Capabilities Identity How This Works

## What this folder is

`system/runtime/capabilities/identity/` is one shipped runtime capability slice.
...
sequenceDiagram
    ...
    Entry->>Owned: Step 1: reach `system/runtime/capabilities/identity/` through the current story
...
Open [`keycloak/how-this-works.md`](./keycloak/how-this-works.md).
...
- open `keycloak/how-this-works.md` when the symptom clearly belongs to that child story

## What to remember

- `system/runtime/capabilities/identity/` exists so this slice has one obvious home.
