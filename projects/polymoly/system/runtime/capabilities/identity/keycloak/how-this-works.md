---
title: system-runtime-capabilities-identity-keycloak-how-this-works
owner: platform@polymoly
last_reviewed: 2026-03-13
classification: internal
---

# System Runtime Capabilities Identity Keycloak How This Works

## What this folder is

`system/runtime/capabilities/identity/keycloak/` is one shipped runtime capability slice.
...
sequenceDiagram
    ...
    Entry->>Owned: Step 1: reach `system/runtime/capabilities/identity/keycloak/` through the current story
...
- when the `system/runtime/capabilities/identity/keycloak/` story needs this responsibility, it opens `base.yaml`
...
- when the `system/runtime/capabilities/identity/keycloak/` story needs this responsibility, it opens `module.yaml`
...
- `system/runtime/capabilities/identity/keycloak/` exists so this slice has one obvious home.
