---
title: system-runtime-capabilities-ai-contract-how-this-works
owner: platform@polymoly
last_reviewed: 2026-03-13
classification: internal
---

# System Runtime Capabilities Ai Contract How This Works

## What this folder is

`system/runtime/capabilities/ai/contract/` holds the contract files that describe this capability to the rest of the system.
...
sequenceDiagram
    ...
    Entry->>Owned: Step 1: reach `system/runtime/capabilities/ai/contract/` through the current story
...
- when the `system/runtime/capabilities/ai/contract/` story needs this responsibility, it opens `capability.yaml`
...
- `system/runtime/capabilities/ai/contract/` exists so this slice has one obvious home.
