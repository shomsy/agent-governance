---
title: system-runtime-capabilities-ai-how-this-works
owner: platform@polymoly
last_reviewed: 2026-03-13
classification: internal
---

# System Runtime Capabilities Ai How This Works

## What this folder is

`system/runtime/capabilities/ai/` is one shipped runtime capability slice.
...
sequenceDiagram
    ...
    Entry->>Owned: Step 1: reach `system/runtime/capabilities/ai/` through the current story
...
Open [`nanoclaw/how-this-works.md`](./nanoclaw/how-this-works.md).
...
- open `nanoclaw/how-this-works.md` when the symptom clearly belongs to that child story

## What to remember

- `system/runtime/capabilities/ai/` exists so this slice has one obvious home.
