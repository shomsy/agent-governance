---
title: system-tools-poly-cmd-poly-how-this-works
owner: platform@polymoly
last_reviewed: 2026-03-13
classification: internal
---

# System Tools Poly Cmd Poly How This Works

## What this folder is

`system/tools/poly/cmd/poly/` is the source-native entrypoint of the Poly CLI.

If you want the very first executable Go code behind `go run ./system/tools/poly/cmd/poly`, this is the folder to open.
...
- `system/tools/poly/cmd/poly/main.go` is the source-native CLI entrypoint.
- function: `main()`
- `main()` -> `cli.RouteRootCommands(...)` after repo-root resolution succeeds
...
sequenceDiagram
    ...
    Entry->>Owned: Step 1: reach `system/tools/poly/cmd/poly/` through the current story
...
- when the `system/tools/poly/cmd/poly/` story needs this responsibility, it opens `main.go`
...
- `system/tools/poly/cmd/poly/` exists so this slice has one obvious home.
