---
title: system-tools-poly-cmd-how-this-works
owner: platform@polymoly
last_reviewed: 2026-03-13
classification: internal
---

# System Tools Poly Cmd How This Works

## What this folder is

`system/tools/poly/cmd/` holds command entrypoint code for Poly tooling.

These folders are where source-native executable code starts before the deeper internal slices take over.
...
- this folder owns one concrete tooling step, often starting with `poly/`
...
flowchart TD
    ...
    A["1. a real `poly ...`, gate, or script entry reaches this tooling slice"]:::step1 --> B["2. this folder owns one concrete tooling step, often starting with `poly/`"]:::step2
...
sequenceDiagram
    ...
    Entry->>Owned: Step 1: reach `system/tools/poly/cmd/` through the current story
...
- `system/tools/poly/cmd/` exists so this slice has one obvious home.
