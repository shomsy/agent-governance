...
- External entry: One request reaches the fixture boundary.
- Protected side: The controlled signal path stays behind the boundary.
- Failure posture: If the boundary check is unclear, the fixture stops instead of continuing.
...
#### 🧩 Imagine It Like
- The Signal Flow stays visible to the reader.
#### 🔎 Lemme Explain
