---
title: system-shared-errors-how-this-works
owner: platform@polymoly
last_reviewed: 2026-03-13
classification: internal
---

# System Shared Errors How This Works

## What this folder is

`system/shared/errors/` is the home for shared error vocabulary and error-shaping helpers.

It exists so failure text and failure contracts do not drift across the codebase.
...
- this folder does one small machine-facing job, often starting in `.gitkeep`
...
flowchart TD
    ...
    A["1. a higher story hands this slice one real machine job"]:::step1 --> B["2. this slice does one concrete machine job, often starting in `.gitkeep`"]:::step2
...
sequenceDiagram
    ...
    Entry->>Owned: Step 1: reach `system/shared/errors/` through the current story
...
- when the `system/shared/errors/` story needs this responsibility, it opens `.gitkeep`
...
- `system/shared/errors/` exists so this slice has one obvious home.
