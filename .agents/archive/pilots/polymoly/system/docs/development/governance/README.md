...
2. vendored shared governance from `shomsy/agent-harness`
...
- `PARENT-AGENTS.md`
  Vendored shared parent contract copied from `agent-harness`.
...
4. vendored shared docs under `shared/agent-harness/**`
...
- repo: `https://github.com/shomsy/agent-harness`
- lock file: `system/docs/development/governance/upstream-source.lock.json`
- sync helper: `system/scripts/governance/sync-agent-harness.sh`

Sync is intentional, not automatic:

1. update or clone `agent-harness`
...
- `PARENT-AGENTS.md`
- `shared/agent-harness/execution-policy.md`
- `shared/agent-harness/how-to-code-review.md`
- `shared/agent-harness/how-to-coding-standards.md`
- `shared/agent-harness/how-to-document.md`
- `shared/agent-harness/release-and-rollback-policy.md`
