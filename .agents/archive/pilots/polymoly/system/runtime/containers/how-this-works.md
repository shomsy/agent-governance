---
title: system-runtime-containers-how-this-works
owner: platform@polymoly
last_reviewed: 2026-03-13
classification: internal
---

# System Runtime Containers How This Works

## What this folder is

`system/runtime/containers/` is the home for shared container-side shipped assets.

It is a runtime asset folder, not a decision folder. Later render or build flows read what is shipped here.
...
- `system/engine/generate/render/` and build-facing flows read from this tree after container output is needed
- this folder is shipped asset truth, not a second decision layer

## The simplest story

- a higher engine or render flow has already decided this shipped runtime slice matters
- this folder contributes concrete assets or defaults, often starting with `.gitkeep`
...
flowchart TD
    ...
    A["1. a higher engine or render flow has already decided this shipped runtime slice matters"]:::step1 --> B["2. this folder contributes concrete assets or defaults, often starting with `.gitkeep`"]:::step2
...
sequenceDiagram
    ...
    Entry->>Owned: Step 1: reach `system/runtime/containers/` through the current story
...
- when the `system/runtime/containers/` story needs this responsibility, it opens `.gitkeep`
...
- `system/runtime/containers/` exists so this slice has one obvious home.
