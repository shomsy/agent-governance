---
title: system-runtime-capabilities-observability-providers-loki-how-this-works
owner: platform@polymoly
last_reviewed: 2026-03-13
classification: internal
---

# System Runtime Capabilities Observability Providers Loki How This Works

## What this folder is

`system/runtime/capabilities/observability/providers/loki/` is one shipped runtime capability slice.
...
sequenceDiagram
    ...
    Entry->>Owned: Step 1: reach `system/runtime/capabilities/observability/providers/loki/` through the current story
...
- when the `system/runtime/capabilities/observability/providers/loki/` story needs this responsibility, it opens `loki.yaml`
...
- `system/runtime/capabilities/observability/providers/loki/` exists so this slice has one obvious home.
