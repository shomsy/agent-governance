---
title: system-runtime-capabilities-messaging-how-this-works
owner: platform@polymoly
last_reviewed: 2026-03-13
classification: internal
---

# System Runtime Capabilities Messaging How This Works

## What this folder is

`system/runtime/capabilities/messaging/` is one shipped runtime capability slice.
...
sequenceDiagram
    ...
    Entry->>Owned: Step 1: reach `system/runtime/capabilities/messaging/` through the current story
...
Open [`rabbitmq/how-this-works.md`](./rabbitmq/how-this-works.md).
...
- open `rabbitmq/how-this-works.md` when the symptom clearly belongs to that child story

## What to remember

- `system/runtime/capabilities/messaging/` exists so this slice has one obvious home.
