---
title: system-runtime-capabilities-app-php-how-this-works
owner: platform@polymoly
last_reviewed: 2026-03-13
classification: internal
---

# System Runtime Capabilities App Php How This Works

## What this folder is

`system/runtime/capabilities/app/php/` is one shipped runtime capability slice.
...
- this folder contributes concrete assets or defaults, often starting with `module.yaml`
...
flowchart TD
    ...
    A["1. a higher engine or render flow has already decided this shipped runtime slice matters"]:::step1 --> B["2. this folder contributes concrete assets or defaults, often starting with `module.yaml`"]:::step2
...
sequenceDiagram
    ...
    participant Owned as module.yaml
    participant Next as apache/
    participant Result as VisibleResult

    Entry->>Owned: Step 1: reach `system/runtime/capabilities/app/php/` through the current story
    Owned->>Owned: Step 2: perform the folder-owned work in `module.yaml`
...
- **Step 2:** The first real work starts in `module.yaml`.
...
- when the `system/runtime/capabilities/app/php/` story needs this responsibility, it opens `module.yaml`
...
Open [`apache/how-this-works.md`](./apache/how-this-works.md).
...
Open [`fpm/how-this-works.md`](./fpm/how-this-works.md).
...
Open [`frankenphp/how-this-works.md`](./frankenphp/how-this-works.md).
...
Open [`nginx/how-this-works.md`](./nginx/how-this-works.md).
...
Open [`roadrunner/how-this-works.md`](./roadrunner/how-this-works.md).
...
- `system/runtime/capabilities/app/php/` exists so this slice has one obvious home.
