---
title: system-runtime-capabilities-app-go-how-this-works
owner: platform@polymoly
last_reviewed: 2026-03-13
classification: internal
---

# System Runtime Capabilities App Go How This Works

## What this folder is

`system/runtime/capabilities/app/go/` is one shipped runtime capability slice.
...
sequenceDiagram
    ...
    Entry->>Owned: Step 1: reach `system/runtime/capabilities/app/go/` through the current story
...
- when the `system/runtime/capabilities/app/go/` story needs this responsibility, it opens `main.go`
...
- when the `system/runtime/capabilities/app/go/` story needs this responsibility, it opens `module.yaml`
...
- `system/runtime/capabilities/app/go/` exists so this slice has one obvious home.
