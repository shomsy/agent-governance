---
title: system-runtime-capabilities-storage-how-this-works
owner: platform@polymoly
last_reviewed: 2026-03-13
classification: internal
---

# System Runtime Capabilities Storage How This Works

## What this folder is

`system/runtime/capabilities/storage/` is one shipped runtime capability slice.
...
sequenceDiagram
    ...
    Entry->>Owned: Step 1: reach `system/runtime/capabilities/storage/` through the current story
...
Open [`minio/how-this-works.md`](./minio/how-this-works.md).
...
- open `minio/how-this-works.md` when the symptom clearly belongs to that child story

## What to remember

- `system/runtime/capabilities/storage/` exists so this slice has one obvious home.
