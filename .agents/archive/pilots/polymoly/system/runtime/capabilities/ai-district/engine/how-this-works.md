---
title: system-runtime-capabilities-ai-district-engine-how-this-works
owner: platform@polymoly
last_reviewed: 2026-03-13
classification: internal
---

# System Runtime Capabilities Ai District Engine How This Works

## What this folder is

`system/runtime/capabilities/ai-district/engine/` holds the shipped engine or image build assets for this runtime capability.
...
sequenceDiagram
    ...
    Entry->>Owned: Step 1: reach `system/runtime/capabilities/ai-district/engine/` through the current story
...
- when the `system/runtime/capabilities/ai-district/engine/` story needs this responsibility, it opens `Dockerfile`
...
- when the `system/runtime/capabilities/ai-district/engine/` story needs this responsibility, it opens `Dockerfile.rootless-buildkit`
...
- `system/runtime/capabilities/ai-district/engine/` exists so this slice has one obvious home.
