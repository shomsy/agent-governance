---
title: system-runtime-capabilities-ai-nanoclaw-how-this-works
owner: platform@polymoly
last_reviewed: 2026-03-13
classification: internal
---

# System Runtime Capabilities Ai Nanoclaw How This Works

## What this folder is

`system/runtime/capabilities/ai/nanoclaw/` is one shipped runtime capability slice.
...
sequenceDiagram
    ...
    Entry->>Owned: Step 1: reach `system/runtime/capabilities/ai/nanoclaw/` through the current story
...
- when the `system/runtime/capabilities/ai/nanoclaw/` story needs this responsibility, it opens `base.yaml`
...
- when the `system/runtime/capabilities/ai/nanoclaw/` story needs this responsibility, it opens `module.yaml`
...
- `system/runtime/capabilities/ai/nanoclaw/` exists so this slice has one obvious home.
