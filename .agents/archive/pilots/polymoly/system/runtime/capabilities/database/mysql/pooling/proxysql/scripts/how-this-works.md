---
title: system-runtime-capabilities-database-mysql-pooling-proxysql-scripts-how-this-works
owner: platform@polymoly
last_reviewed: 2026-03-13
classification: internal
---

# System Runtime Capabilities Database Mysql Pooling Proxysql Scripts How This Works

## What this folder is

`system/runtime/capabilities/database/mysql/pooling/proxysql/scripts/` holds shipped helper scripts for this capability.
...
sequenceDiagram
    ...
    Entry->>Owned: Step 1: reach `system/runtime/capabilities/database/mysql/pooling/proxysql/scripts/` through the current story
...
- when the `system/runtime/capabilities/database/mysql/pooling/proxysql/scripts/` story needs this responsibility, it opens `Dockerfile`
...
- `system/runtime/capabilities/database/mysql/pooling/proxysql/scripts/` exists so this slice has one obvious home.
