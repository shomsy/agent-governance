---
title: system-runtime-capabilities-gateway-providers-crowdsec-how-this-works
owner: platform@polymoly
last_reviewed: 2026-03-13
classification: internal
---

# System Runtime Capabilities Gateway Providers Crowdsec How This Works

## What this folder is

`system/runtime/capabilities/gateway/providers/crowdsec/` is one shipped runtime capability slice.
...
sequenceDiagram
    ...
    Entry->>Owned: Step 1: reach `system/runtime/capabilities/gateway/providers/crowdsec/` through the current story
...
- `system/runtime/capabilities/gateway/providers/crowdsec/` exists so this slice has one obvious home.
