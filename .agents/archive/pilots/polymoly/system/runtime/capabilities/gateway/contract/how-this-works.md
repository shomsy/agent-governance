---
title: system-runtime-capabilities-gateway-contract-how-this-works
owner: platform@polymoly
last_reviewed: 2026-03-13
classification: internal
---

# System Runtime Capabilities Gateway Contract How This Works

## What this folder is

`system/runtime/capabilities/gateway/contract/` holds the contract files that describe this capability to the rest of the system.
...
sequenceDiagram
    ...
    Entry->>Owned: Step 1: reach `system/runtime/capabilities/gateway/contract/` through the current story
...
- when the `system/runtime/capabilities/gateway/contract/` story needs this responsibility, it opens `capability.yaml`
...
- `system/runtime/capabilities/gateway/contract/` exists so this slice has one obvious home.
